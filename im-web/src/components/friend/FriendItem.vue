		...
		<div class="friend-item" :class="itemClass" @contextmenu.prevent="showRightMenu($event)">
			...
			<div class="friend-info">
				...
				<!-- <div class="friend-online">
					<i class="el-icon-monitor online" v-show="friend.onlineWeb" :title="$t('friend.onlinePc')">
						<span class="online-icon"></span>
					</i>
					<i class="el-icon-mobile-phone online" v-show="friend.onlineApp" :title="$t('friend.onlineMobile')">
						<span class="online-icon"></span>
					</i>
				</div> -->
			</div>
