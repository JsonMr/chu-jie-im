<template>
    <el-dialog :visible.sync="isShow" v-dialogDrag :modal="true" :close-on-click-modal="true"
        ...
        :before-close="close" :title="$t('setting.personalInfo')">
        <div class="user-profile-card">
            ...
            <div class="profile-header">
                ...
                <div class="user-info-content">
                    ...
                    <p class="user-id">{{ $t('common.userName') }}: {{ userInfo.userName }}</p>
                    <p class="user-id">ID: {{ userInfo.code }}</p>
                    <div class="user-status">
                        <span class="status-dot online"></span>
                        <span class="status-text">{{ $t('personalInfo.online') }}</span>
                    </div>
                </div>
            </div>
            ...
            <div class="profile-details">
                <div class="detail-item" v-if="userInfo.companyName">
                    <div class="detail-label">
                        ...
                        <span>{{ $t('personalInfo.company') }}</span>
                    </div>
                ...
                <div class="detail-item">
                    <div class="detail-label">
                        ...
                        <span>{{ $t('personalInfo.sex') }}</span>
                    </div>
                    <div class="detail-value">
                        {{ userInfo.sex === 0 ? $t('friend.male') : userInfo.sex === 1 ? $t('friend.female') :
                            $t('personalInfo.sexNotSet') }}
                    </div>
                </div>
                ...
                <div class="detail-item signature-item">
                    <div class="signature-label">
                        ...
                        <span>{{ $t('personalInfo.signature') }}</span>
                    </div>
                    ...
                    <div class="signature-empty" v-else @click="goToPersonalSettings">
                        ...
                        <div class="empty-text">
                            <p class="empty-title">{{ $t('personalInfo.noSignatureTitle') }}</p>
                            <p class="empty-desc">{{ $t('personalInfo.noSignatureDesc') }}</p>
                        </div>
                    </div>
                </div>
            </div>
